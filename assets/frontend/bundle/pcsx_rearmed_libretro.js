...
function nullFunc_vffffff(x) { Module["printErr"]("Invalid function pointer called with signature 'vffffff'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  Module["printErr"]("Build with ASSERTIONS=2 for more info.");abort(x) }
...
Module['wasmTableSize'] = 143171;

Module['wasmMaxTableSize'] = 143171;
...
function invoke_vffffff(index,a1,a2,a3,a4,a5,a6) {
  try {
    Module["dynCall_vffffff"](index,a1,a2,a3,a4,a5,a6);
  } catch(e) {
    if (typeof e !== 'number' && e !== 'longjmp') throw e;
    Module["setThrew"](1, 0);
  }
...
var real__glBindTexture = asm["_glBindTexture"]; asm["_glBindTexture"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__glBindTexture.apply(null, arguments);
};

var real__glDeleteTextures = asm["_glDeleteTextures"]; asm["_glDeleteTextures"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__glDeleteTextures.apply(null, arguments);
};

var real__glGenTextures = asm["_glGenTextures"]; asm["_glGenTextures"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__glGenTextures.apply(null, arguments);
};

var real__glGetIntegerv = asm["_glGetIntegerv"]; asm["_glGetIntegerv"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__glGetIntegerv.apply(null, arguments);
};

var real__glTexParameteri = asm["_glTexParameteri"]; asm["_glTexParameteri"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__glTexParameteri.apply(null, arguments);
};
...
var _glBindTexture = Module["_glBindTexture"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_glBindTexture"].apply(null, arguments) };
var _glDeleteTextures = Module["_glDeleteTextures"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_glDeleteTextures"].apply(null, arguments) };
var _glGenTextures = Module["_glGenTextures"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_glGenTextures"].apply(null, arguments) };
var _glGetIntegerv = Module["_glGetIntegerv"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_glGetIntegerv"].apply(null, arguments) };
var _glTexParameteri = Module["_glTexParameteri"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_glTexParameteri"].apply(null, arguments) };
...
var dynCall_vffffff = Module["dynCall_vffffff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_vffffff"].apply(null, arguments) };
