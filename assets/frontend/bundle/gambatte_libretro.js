...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'gambatte_libretro.wast';
  var wasmBinaryFile = 'gambatte_libretro.wasm';
  var asmjsCodeFile = 'gambatte_libretro.temp.asm.js';
...
STATICTOP = STATIC_BASE + 1008848;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_libretro_cpp() } }, { func: function() { __GLOBAL__sub_I_statesaver_cpp() } }, { func: function() { __GLOBAL__sub_I_envelope_unit_cpp() } }, { func: function() { ___emscripten_environ_constructor() } });
...
Module['wasmTableSize'] = 154306;

Module['wasmMaxTableSize'] = 154306;
...
var real___GLOBAL__sub_I_statesaver_cpp = asm["__GLOBAL__sub_I_statesaver_cpp"]; asm["__GLOBAL__sub_I_statesaver_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_statesaver_cpp.apply(null, arguments);
};
...
Module["asm"] = asm;
var __GLOBAL__sub_I_envelope_unit_cpp = Module["__GLOBAL__sub_I_envelope_unit_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_envelope_unit_cpp"].apply(null, arguments) };
...
var __GLOBAL__sub_I_statesaver_cpp = Module["__GLOBAL__sub_I_statesaver_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_statesaver_cpp"].apply(null, arguments) };
