...
function integrateWasmJS() {
    var wasmTextFile = "mame2003_plus_libretro.wast";
    var wasmBinaryFile = "mame2003_plus_libretro.wasm";
    var asmjsCodeFile = "mame2003_plus_libretro.temp.asm.js";
...
STATICTOP = STATIC_BASE + 25775840;
__ATINIT__.push();
var STATIC_BUMP = 25775840;
...
function _MD5_Final() {
    Module["printErr"]("missing function: MD5_Final");
    abort(-1)
}

function _MD5_Init() {
    Module["printErr"]("missing function: MD5_Init");
    abort(-1)
}

function _MD5_Update() {
    Module["printErr"]("missing function: MD5_Update");
    abort(-1)
}
...
Module["wasmTableSize"] = 47458;
Module["wasmMaxTableSize"] = 47458;
...
Module.asmLibraryArg = {
    ...
    "invoke_vj": invoke_vj,
    "_MD5_Final": _MD5_Final,
    "_MD5_Init": _MD5_Init,
    "_MD5_Update": _MD5_Update,
