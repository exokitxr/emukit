...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'mednafen_pcfx_libretro.wast';
  var wasmBinaryFile = 'mednafen_pcfx_libretro.wasm';
  var asmjsCodeFile = 'mednafen_pcfx_libretro.temp.asm.js';
...
STATICTOP = STATIC_BASE + 2374272;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_lec_cpp() } }, { func: function() { __GLOBAL__sub_I_mempatcher_cpp() } }, { func: function() { __GLOBAL__sub_I_libretro_cpp() } }, { func: function() { ___emscripten_environ_constructor() } });
...
Module['wasmTableSize'] = 152066;

Module['wasmMaxTableSize'] = 152066;
...
Module["asm"] = asm;
var __GLOBAL__sub_I_lec_cpp = Module["__GLOBAL__sub_I_lec_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_lec_cpp"].apply(null, arguments) };
