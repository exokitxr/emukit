...
var TOTAL_MEMORY = Module['TOTAL_MEMORY'] || 1610612736;
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'mednafen_psx_hw_libretro.wast';
  var wasmBinaryFile = 'mednafen_psx_hw_libretro.wasm';
  var asmjsCodeFile = 'mednafen_psx_hw_libretro.temp.asm.js';
...
STATICTOP = STATIC_BASE + 517173520;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_libretro_cpp() } }, { func: function() { __GLOBAL__sub_I_gpu_cpp() } }, { func: function() { __GLOBAL__sub_I_mdec_cpp() } }, { func: function() { __GLOBAL__sub_I_mempatcher_cpp() } }, { func: function() { ___emscripten_environ_constructor() } });
...
// {{PRE_LIBRARY}}
  ...
  function _emscripten_glBindBuffer(target, buffer) {
      ...
      if (target == 0x88EB /*GL_PIXEL_PACK_BUFFER*/) {
        // In WebGL 2 glReadPixels lol entry point, we need to use a different WebGL 2 API function call when a buffer is bound to
  ...
  function emscriptenWebGLComputeImageSize(width, height, sizePerPixel, alignment) {
      ...
      switch (type) {
        ...
        case 0x8034: case 33638 /* GL_UNSIGNED_SHORT_5_5_5_1 */:
          sizePerPixel = 2;
          break;
        default:
          GL.recordError(0x0500); // GL_INVALID_ENUM
  ...
  function _scond_free() {
  Module['printErr']('missing function: scond_free'); abort(-1);
  }

  function _scond_new() {
  Module['printErr']('missing function: scond_new'); abort(-1);
  }

  function _scond_signal() {
  Module['printErr']('missing function: scond_signal'); abort(-1);
  }

  function _scond_wait() {
  Module['printErr']('missing function: scond_wait'); abort(-1);
  }

  function _scond_wait_timeout() {
  Module['printErr']('missing function: scond_wait_timeout'); abort(-1);
  }

  function _slock_free() {
  Module['printErr']('missing function: slock_free'); abort(-1);
  }

  function _slock_lock() {
  Module['printErr']('missing function: slock_lock'); abort(-1);
  }

  function _slock_new() {
  Module['printErr']('missing function: slock_new'); abort(-1);
  }

  function _slock_unlock() {
  Module['printErr']('missing function: slock_unlock'); abort(-1);
  }

  function _sthread_create() {
  Module['printErr']('missing function: sthread_create'); abort(-1);
  }

  function _sthread_join() {
  Module['printErr']('missing function: sthread_join'); abort(-1);
  }
...
Module['wasmTableSize'] = 169474;

Module['wasmMaxTableSize'] = 169474;
...
Module["asm"] = asm;
var __GLOBAL__sub_I_gpu_cpp = Module["__GLOBAL__sub_I_gpu_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_gpu_cpp"].apply(null, arguments) };
...
var __GLOBAL__sub_I_mdec_cpp = Module["__GLOBAL__sub_I_mdec_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_mdec_cpp"].apply(null, arguments) };
